...
class HttpClient:
    ...
    def request_json(self, request: HttpRequest) -> dict[str, Any]:
        ...
        try:
            ...
            logger.error("HTTP 请求失败: %s %s - %s", request.method, request.url, exc)
...
class BaseApiClient:
    ...
    封装基础 URL 与 JSON 请求方法，具体平台客户端可在其上构建。
    """
    ...
    def __init__(self, base_url: str, http_client: HttpClient | None = None) -> None:
        ...
        :param http_client: 可选的自定义 HttpClient 实例
        """

        self._base_url = base_url.rstrip("/")
        self._http = http_client or _get_default_http_client()
    ...
    def _request_json(
        ...
        return self._http.request_json(request)
